...
predictInternalOneRuleTest <- function(){
  ...
  norn <- addRule.norn(norn, list(L1 = c(0.2, 0.9), L3 = c(1, 0.6, 1)))
...
predictInternalMultipleRulesTest <- function(){
  ...
  norn <- as.norn.rsl(rsl)
  norn <- addRule.norn(norn, list(L1 = c(0.2, 0.9), L3 = c(1, 0.6, 1)))
  norn <- addRule.norn(norn, list(L1 = c(0.6, 0.1), L2 = c(0.2, 1)))
...
predictInternalLoopTest <- function(){
  ...
  norn <- addRule.norn(norn, list(L1 = c(0.2, 0.9), L3 = c(1, 0.6, 1)))
  norn <- addRule.norn(norn, list(L1 = c(0.6, 0.1), L2 = c(0.2, 1)))
  norn <- addRule.norn(norn, list(L2 = c(0.8, 0.1), L3 = c(0.1, 1, 0.95)))
